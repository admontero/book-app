        ...
        <div class="px-6 py-4 bg-white dark:bg-gray-800 rounded-md border border-gray-200 dark:border-gray-700 mt-6">
            ...
            <form wire:submit.prevent="save">
                <div class="md:grid md:grid-cols-3 md:gap-4">
                    ...
                    @if ($loan_status == App\Enums\LoanStatusEnum::COMPLETADO->value)
                        <div class="mt-4 md:mt-0">
                            <x-label value="Fecha de Devolución" />
                            ...
                            <x-input
                                ...
                                x-init="
                                    ...
                                    datedeathpicker.setDate($wire.devolution_date ?? null)

                                    $el.addEventListener('changeDate', (event) => $wire.devolution_date = event.detail.date ? event.detail.date.toLocaleDateString('en-GB') : null);
                                "
                                x-mask="99/99/9999"
                            />
                        </div>
