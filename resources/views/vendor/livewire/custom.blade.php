        ...
        <div class="mt-6 sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex items-center mt-4 gap-x-4 sm:mt-0">
                ...
                @if ($paginator->onFirstPage())
                    <p class="flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 capitalize bg-white border rounded-md sm:w-auto gap-x-2 dark:bg-gray-900 dark:text-gray-200 dark:border-gray-700">
